\section{Results}
  ...
  \subsection{Inhibition of cell motility}
    ...
    but did not achieve complete immobilisation \frefp{fig:kill-frap:confluent-hela}.
    ...
    when surrounded by neighbours \addref{?}. Since HeLa cells have 
    lost the ability to activate contact inhibition \addref{?},
...
%      \end{figure}
    ...
    after activating and following H2B--PAGFP in \G1{} cells \frefp{fig:kill-frap:ifrap}.
    ...
    \end{figure}
\todo{Can you add an additional section in ifrap figure with 3-4 still images of different very stark non-homogenous diffusion examples}